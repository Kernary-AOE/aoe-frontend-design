...
description: Create visually distinctive, high-impact frontend interfaces using the four-vector approach (typography, color/theme, motion, backgrounds). Avoid generic AI slop aesthetics.
---
