...
**Better Google Fonts alternatives** (all blacklist-safe):
- Instead of Inter → **Instrument Sans**, **Outfit**, **Figtree**
- Instead of Roboto → **Onest**, **Urbanist**, **Nunito Sans**
- Instead of Open Sans → **Source Sans 3**, **Sora**, **Geist Sans**
- For editorial/premium feel → **Fraunces**, **Newsreader**, **Lora**, **Cormorant Garamond**
- For dense/data UI → **Barlow Condensed**, **IBM Plex Sans**, **Noto Sans**

**NEVER use these as primary body font** (they are the uniform of undifferentiated SaaS): Inter, Roboto, Arial, Space Grotesk, Plus Jakarta Sans, DM Sans.
