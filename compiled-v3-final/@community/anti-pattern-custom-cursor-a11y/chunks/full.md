...
## Risks
- cursor: none on :root — erases system cursor on browser scrollbars, native dialogs, and <select> elements that CSS cannot reach
...
- Restore system cursor semantics on <a>, <button>, <input>, <textarea>, <select> even inside the branded zone.
