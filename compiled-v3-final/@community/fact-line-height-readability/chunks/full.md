...
## Source
- Bringhurst, 'The Elements of Typographic Style' — chapter on leading
- WCAG 2.2 SC 1.4.12 Text Spacing — line-height ≥ 1.5 within paragraphs
- Smashing Magazine, 'Setting Optimal Line Length' / line-height research
- Google Material — Type scale line-height tokens
