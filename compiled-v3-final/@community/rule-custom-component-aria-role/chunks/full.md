...
## Rationale
Assistive technology uses the role attribute to determine how to announce an element and what keyboard interactions to expect. A <div> acting as a button without role=button is silent and inoperable to screen readers. Custom components that omit correct roles exclude keyboard-only and screen-reader users.
