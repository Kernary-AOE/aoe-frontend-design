...
## Rationale
Unfreezing validated decisions without new evidence is a productivity trap. It signals to the team that no decision is permanent, which creates insecurity in the design process and causes teams to under-invest in shipping because changes feel reversible at any time.
