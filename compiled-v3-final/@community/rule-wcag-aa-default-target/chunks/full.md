...
## Rationale
AA is the conformance level required or referenced by most accessibility regulations worldwide (ADA, EN 301 549, AODA). Targeting it by default ensures broad user coverage and limits legal exposure. Level A alone is insufficient; AAA is aspirational but not required universally.
